...
# Call the function and display the cleaned dataset
cleaned_data = clean_and_modify_data(sales_data)  # Clean the data
cleaned_data.head(30)                         # Display the cleaned data
